    ...
    await api("/api/benchmark/inputs", {
      ...
      body: { inputs: {
        ...
        computed: {
          ...
          window: range === "recent" ? "2024+" : range,
          widened_to_all_fields: pool.widened,
          sample_n: stats.n,
          ...
          low_citation_precedents: stats.lowWins,
          eb1a_percentile: dual?.find((d) => d.cat === "EB1A")?.pct ?? null,
          expected_processing_days_p50:
            timeline?.p ? Math.round(timeline.p[1]) : null,
        },
      } },
    });
    setSaved(true);
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-6">
      <Header active="benchmark"
              progress={{
                label: savedOnce ? "saved to your case ✓"
                  : (myCites != null || myPubs != null) ? "now: Save to my case"
      ...
      <div className="flex items-center justify-between mt-5">
        ...
        <button className="btn" onClick={save} disabled={myCites == null && myPubs == null}>
