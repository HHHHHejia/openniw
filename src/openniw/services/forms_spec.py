...
WIZARD: list[dict] = [
    {
        ...
        "fields": [
            ...
            {"key": "native_name.given", "label": "Given name in native alphabet",
             "type": "text"},
            {"key": "native_name.middle", "label": "Middle name in native alphabet",
             "type": "text"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "mailing.state", "label": "State (2-letter)", "type": "state",
             "required": True},
            {"key": "mailing.zip", "label": "ZIP code", "type": "text",
             "required": True},
            {"key": "mailing.province", "label": "Province (non-U.S. address)",
             "type": "text", "help": "Leave blank for U.S. addresses."},
            {"key": "mailing.postal_code",
             "label": "Postal code (non-U.S. address)", "type": "text",
             "help": "Leave blank for U.S. addresses."},
            {"key": "mailing.country", "label": "Country (if not U.S.)",
             "type": "country", "help": "Leave blank for U.S. addresses."},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "us_presence.date_of_arrival",
             "label": "Date of last arrival (MM/DD/YYYY)", "type": "date"},
            {"key": "processing.prior_petition",
             "label": "Have you ever filed an immigrant petition before?",
             "type": "boolean"},
            {"key": "processing.in_proceedings",
             "label": "Are you in removal/deportation proceedings?",
             "type": "boolean"},
            {"key": "us_presence.i94_number", "label": "I-94 number", "type": "text",
             "help": "Download your most recent I-94 from the CBP website."},
            {"key": "us_presence.travel_doc_number",
             "label": "Travel document number (if any)", "type": "text",
             "help": "Only if you travel on a document other than a passport."},
            {"key": "us_presence.current_status",
             "label": "Current nonimmigrant status (F-1, H-1B, O-1...)",
             "type": "select",
             "options": ["F-1", "F-1 OPT", "F-1 STEM OPT", "J-1", "J-2", "H-1B", "H-4", "O-1", "O-3", "L-1", "L-2", "E-2", "E-3", "TN", "B-1/B-2", "Parolee", "Other"]},
            {"key": "us_presence.passport_number", "label": "Passport number",
             "type": "text"},
            {"key": "us_presence.passport_country",
             "label": "Passport country of issuance", "type": "country"},
            {"key": "us_presence.passport_exp",
             "label": "Passport expiration (MM/DD/YYYY)", "type": "date"},
    ...
    },
    {
        ...
        "fields": [
            ...
            {"key": "employment.hours",
             "label": "Hours per week (if not full-time)", "type": "text"},
            ...
            {"key": "employment.wages_per", "label": "Wages per (year/month/hour)",
             "type": "select",
             "options": ["year", "month", "biweekly", "week", "hour"], "default": "year"},
            ...
            {"key": "petitioner.annual_income", "label": "Annual income (USD)",
             ...
             "help": "Salary + cash bonus only; exclude stock, insurance, "
                     "tuition benefits."},
            {"key": "petitioner.nonprofit",
             "label": "Is your employer a nonprofit organization?",
             "type": "boolean"},
            {"key": "petitioner.small_employer",
             "label": "Small employer (25 or fewer full-time employees)?",
             "type": "boolean", "default": True,
             "help": "Sets the Asylum Program Fee answer on I-140. As a "
                     "self-petitioner you are the petitioner: answer for "
                     "yourself (default yes → $300 fee)."},
        ],
    },
    {
        "id": "education",
        ...
        "fields": [
            {"key": "degrees", "label": "Degrees", "type": "degree_list",
             ...
             "help": "Highest first. Level is one of: doctorate, master, bachelor, "
                     "associate, other (for 'other', name it in Other label). "
                     "Use the conferral date from your diploma; if the "
                     "transcript shows a Plan/Major, use that wording. Foreign "
                     "degrees need a NACES general evaluation as evidence."},
